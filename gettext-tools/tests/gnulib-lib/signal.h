...
#if defined __need_sig_atomic_t || defined __need_sigset_t || defined _GL_GTTGL_ALREADY_INCLUDING_SIGNAL_H || (defined _SIGNAL_H && !defined __SIZEOF_PTHREAD_MUTEX_T)
...
#ifndef _GL_GTTGL_SIGNAL_H

#define _GL_GTTGL_ALREADY_INCLUDING_SIGNAL_H
...
#undef _GL_GTTGL_ALREADY_INCLUDING_SIGNAL_H

#ifndef _GL_GTTGL_SIGNAL_H
#define _GL_GTTGL_SIGNAL_H
