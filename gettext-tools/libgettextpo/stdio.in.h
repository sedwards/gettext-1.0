...
# if (0 && @REPLACE_FPRINTF@) \
     || (0 && @REPLACE_STDIO_WRITE_FUNCS@ && (0 || 0))
#  if !(defined __cplusplus && defined GNULIB_NAMESPACE)
...
#if 0
# if @REPLACE_STDIO_WRITE_FUNCS@ && (0 || 0)
#  if !(defined __cplusplus && defined GNULIB_NAMESPACE)
#   undef fputc
