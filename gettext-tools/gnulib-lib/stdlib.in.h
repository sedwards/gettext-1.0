...
#if (0 || defined GNULIB_POSIXCHECK) && @HAVE_SYS_LOADAVG_H@
...
#if (0 || defined GNULIB_POSIXCHECK) && @HAVE_SYS_PROCESS_H@
...
#if ((0 && @REPLACE_STRTOL@) || (0 && @REPLACE_STRTOLL@) || (0 && @REPLACE_STRTOUL@) || (0 && @REPLACE_STRTOULL@)) && defined __cplusplus && !defined GNULIB_NAMESPACE && defined __GNUG__ && !defined __clang__ && (defined __sun || defined _AIX)
...
# if @REPLACE_CALLOC_FOR_CALLOC_POSIX@ \
     || (0 && @REPLACE_CALLOC_FOR_CALLOC_GNU@)
#  if !((defined __cplusplus && defined GNULIB_NAMESPACE) \
...
# if @REPLACE_MALLOC_FOR_MALLOC_POSIX@ \
     || (0 && @REPLACE_MALLOC_FOR_MALLOC_GNU@)
#  if !((defined __cplusplus && defined GNULIB_NAMESPACE) \
        || _GL_USE_STDLIB_ALLOC)
#   undef malloc
