...
#define rpl_posix_spawnattr_t posix_spawnattr_t
#include <spawn.h>
extern char **environ;
#define rpl_posix_spawn_file_actions_t posix_spawn_file_actions_t
#define rpl_posix_spawnattr_t posix_spawnattr_t
...
#include <unistd.h>
extern char **environ;
#define posix_spawn_file_actions_t posix_spawn_file_actions_t
#define posix_spawnattr_t posix_spawnattr_t
