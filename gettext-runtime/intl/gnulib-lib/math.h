...
/* Write x as
   ...
   where
     ...
     If x is infinite or NaN: mantissa = x, exp unspecified.
   Store exp in *EXPPTR and return mantissa.  */
#if @GL_GNULIB_FREXPL@ && @REPLACE_FREXPL@
# if !(defined __cplusplus && defined GNULIB_NAMESPACE)
#  undef frexpl
...
# endif
#endif
#if @GL_GNULIB_FREXPL@ && !(@REPLACE_FREXPL@ && !@HAVE_DECL_FREXPL@)
# if __GLIBC__ >= 2
_GL_CXXALIASWARN (frexpl);
# endif
#endif
#if !@GL_GNULIB_FREXPL@ && defined GNULIB_POSIXCHECK
...
/* Return x * 2^exp.  */
#if @GL_GNULIB_LDEXPL@ && @REPLACE_LDEXPL@
# if !(defined __cplusplus && defined GNULIB_NAMESPACE)
#  undef ldexpl
...
# endif
#endif
#if !@GL_GNULIB_LDEXPL@ && defined GNULIB_POSIXCHECK
...
#if @GL_GNULIB_ISFINITE@ || @GL_GNULIB_ISFINITE_NO_CXX@
# if @REPLACE_ISFINITE@
...
#  endif
# endif
# if @GL_GNULIB_ISFINITE@ && defined __cplusplus
...
#if @GL_GNULIB_ISINF@ || @GL_GNULIB_ISINF_NO_CXX@
# if @REPLACE_ISINF@
...
#  endif
# endif
# if @GL_GNULIB_ISINF@ && defined __cplusplus
...
#if @GL_GNULIB_ISNAN@ || @GL_GNULIB_ISNAN_NO_CXX@
# if @REPLACE_ISNAN@
...
#  endif
# endif
# if @GL_GNULIB_ISNAN@ && defined __cplusplus
...
#if @GL_GNULIB_SIGNBIT@ || @GL_GNULIB_SIGNBIT_NO_CXX@
...
# endif
# if @GL_GNULIB_SIGNBIT@ && defined __cplusplus
