...
#if defined __need_system_fcntl_h || defined _GL_LTS_ALREADY_INCLUDING_FCNTL_H
...
#define _GL_LTS_ALREADY_INCLUDING_FCNTL_H
...
#undef _GL_LTS_ALREADY_INCLUDING_FCNTL_H
