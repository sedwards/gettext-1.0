...
#if defined __need_sig_atomic_t || defined __need_sigset_t || defined _GL_LTS_ALREADY_INCLUDING_SIGNAL_H || (defined _SIGNAL_H && !defined __SIZEOF_PTHREAD_MUTEX_T)
...
#define _GL_LTS_ALREADY_INCLUDING_SIGNAL_H
...
#undef _GL_LTS_ALREADY_INCLUDING_SIGNAL_H
