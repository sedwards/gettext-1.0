...
#if defined __need_FILE || defined __need___FILE || defined _GL_LTS_ALREADY_INCLUDING_STDIO_H || defined _GL_SKIP_GNULIB_STDIO_H
...
#define _GL_LTS_ALREADY_INCLUDING_STDIO_H

/* The include_next requires a split double-inclusion guard.  */
#include_next <stdio.h>

#undef _GL_LTS_ALREADY_INCLUDING_STDIO_H
